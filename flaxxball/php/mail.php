...
<body>
    <div class="main_page">
        ...
        Мы работаем с 9:00 до 20:00 без выходных, если Вы оставили заказ в этом промежутке, то мы с Вами свяжемся в течении 15 минут, если позже, то на следующий день с утра.
        </div>
</body>